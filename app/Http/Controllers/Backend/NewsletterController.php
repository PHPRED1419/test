...
class NewsletterController extends Controller
{
    ...
    public function index($isTrashed = false)
    {
        ...
        $query = Newsletter::orderBy('status', 'asc');
            ...
            $contactsDataTable = DataTables::of($contacts, $isTrashed)
                ...
                ->addColumn(
                    ...
                    function ($row) use ($isTrashed) {
                        $html = '<a class="btn waves-effect waves-light btn-info btn-sm btn-circle" title="View Contact Details" href="newsletter/show/'.$row->id .'"><i class="fa fa-eye"></i></a>';
                        return $html;
                    }
                )
    ...
    public function show($id)
    {
       ...
       // $contact->save();
        ...
        return view('backend.pages.newsletter.show', compact('contact'));
    }
