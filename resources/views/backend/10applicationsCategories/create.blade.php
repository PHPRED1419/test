...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.applicationsCategories.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
...
@section('scripts')
@include('backend.applicationsCategories.partials.scripts')
@endsection
