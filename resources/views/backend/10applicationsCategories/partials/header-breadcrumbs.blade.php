        ...
        <div class="col-12 col-md-5 align-self-center">
            <h4 class="page-title">
                ...
                @elseif(Route::is('admin.applicationsCategories.edit'))
                    Edit Category <span class="badge badge-info">{{ $applicationsCategories->name }}</span>
                @endif
            </h4>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        @elseif(Route::is('admin.applicationsCategories.create'))
                        <li class="breadcrumb-item"><a href="{{ route('admin.applicationsCategories.index') }}">Category List</a></li>
