...
?>
                ...
                @if ($user->can('keywords.view') || $user->can('keywords.create'))
               ...
               <li class="sidebar-item ">
                    ...
                    <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.keywords.index') || Route::is('admin.keywords.create') || Route::is('admin.keywords.edit')) ? 'in' : null }}">
                        @if ($user->can('keywords.view'))
                        <li class="sidebar-item">
                            <a href="{{ route('admin.keywords.index') }}" class="sidebar-link {{ (Route::is('admin.keywords.index') || Route::is('admin.keywords.edit')) ? 'active' : null }}">
                                <i class="mdi mdi-view-list"></i>
                        ...
                        @if ($user->can('keywords.create'))
                        <li class="sidebar-item">
                            <a href="{{ route('admin.keywords.create') }}" class="sidebar-link {{ Route::is('admin.keywords.create') ? 'active' : null }}">
                                <i class="mdi mdi-plus-circle"></i>
                ...
                */
                    ...
                    <li class="sidebar-item ">
                        ...
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.blogs.index') || Route::is('admin.blogs.create') || Route::is('admin.blogs.edit')) ? 'in' : null }}">
                            @if ($user->can('blog.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.blogsCategories.index') }}" class="sidebar-link {{ (Route::is('admin.blogsCategories.index') || Route::is('admin.blogsCategories.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                ...
                @if ($user->can('imageAlbum.view') || $user->can('imageAlbum.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                            <span class="hide-menu">Image Gallery </span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.image_album.index') || Route::is('admin.image_album.create') || Route::is('admin.image_album.edit')) ? 'in' : null }}">
                            @if ($user->can('imageAlbum.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.image_album.index') }}" class="sidebar-link {{ (Route::is('admin.image_album.index') || Route::is('admin.image_album.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                                 ...
                                 <li class="sidebar-item">
                                    <a href="{{ route('admin.image_gallery.index') }}" class="sidebar-link {{ (Route::is('admin.image_gallery.index') || Route::is('admin.image_gallery.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                ...
                @if ($user->can('videoAlbum.view') || $user->can('videoAlbum.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                            <span class="hide-menu">Video Gallery </span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.video_album.index') || Route::is('admin.video_album.create') || Route::is('admin.video_album.edit')) ? 'in' : null }}">
                            @if ($user->can('videoAlbum.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.video_album.index') }}" class="sidebar-link {{ (Route::is('admin.video_album.index') || Route::is('admin.video_album.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                                 ...
                                 <li class="sidebar-item">
                                    <a href="{{ route('admin.video_gallery.index') }}" class="sidebar-link {{ (Route::is('admin.video_gallery.index') || Route::is('admin.video_gallery.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                ...
                <li class="sidebar-item ">
                    ...
                    <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.products.index') || Route::is('admin.products.create') || Route::is('admin.products.edit')) ? 'in' : null }}">
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('admin.product_enquiry.index') }}" class="sidebar-link {{ (Route::is('admin.product_enquiry.index') || Route::is('admin.product_enquiry.edit')) ? 'active' : null }}">
                                <i class="mdi mdi-view-list"></i>
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('admin.instant_offer_enquiry.index') }}" class="sidebar-link {{ (Route::is('admin.instant_offer_enquiry.index') || Route::is('admin.instant_offer_enquiry.edit')) ? 'active' : null }}">
                                <i class="mdi mdi-view-list"></i>
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('admin.contactus_enquiry.index') }}" class="sidebar-link {{ (Route::is('admin.contactus_enquiry.index') || Route::is('admin.contactus_enquiry.edit')) ? 'active' : null }}">
                                <i class="mdi mdi-view-list"></i>
                        ...
                        <li class="sidebar-item">
                            <a href="{{ route('admin.newsletter.index') }}" class="sidebar-link {{ (Route::is('admin.newsletter.index') || Route::is('admin.newsletter.edit')) ? 'active' : null }}">
                                <i class="mdi mdi-view-list"></i>
                 ...
                 @if ($user->can('pages.view') || $user->can('pages.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                ...
                @if ($user->can('testimonials.view') || $user->can('testimonials.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                            <span class="hide-menu">Testimonials </span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.testimonials.index') || Route::is('admin.testimonials.create') || Route::is('admin.testimonials.edit')) ? 'in' : null }}">
                            @if ($user->can('testimonials.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.testimonials.index') }}" class="sidebar-link {{ (Route::is('admin.testimonials.index') || Route::is('admin.testimonials.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                            ...
                            @if ($user->can('testimonials.create'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.testimonials.create') }}" class="sidebar-link {{ Route::is('admin.testimonials.create') ? 'active' : null }}">
                                        <i class="mdi mdi-plus-circle"></i>
                ...
                @if ($user->can('banners.view') || $user->can('banners.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                            <span class="hide-menu">Banners </span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.banners.index') || Route::is('admin.banners.create') || Route::is('admin.banners.edit')  || Route::is('admin.flashes.index') || Route::is('admin.flashes.create') || Route::is('admin.flashes.edit')) ? 'in' : null }}">
                            @if ($user->can('banners.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.banners.index') }}" class="sidebar-link {{ (Route::is('admin.banners.index') || Route::is('admin.banners.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                            ...
                            @if ($user->can('flashes.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.flashes.index') }}" class="sidebar-link {{ (Route::is('admin.flashes.index') || Route::is('admin.flashes.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                ...
                @endif
                 ...
                 @if ($user->can('faqs.view') || $user->can('faqs.create'))
                    <li class="sidebar-item ">
                        <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                            <i class="mdi mdi-view-headline"></i>
                            <span class="hide-menu">Faq's </span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level {{ (Route::is('admin.faqs.index') || Route::is('admin.faqs.create') || Route::is('admin.faqs.edit')) ? 'in' : null }}">
                            @if ($user->can('faqs.view'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.faqs.index') }}" class="sidebar-link {{ (Route::is('admin.faqs.index') || Route::is('admin.faqs.edit')) ? 'active' : null }}">
                                        <i class="mdi mdi-view-list"></i>
                            ...
                            @if ($user->can('faqs.create'))
                                <li class="sidebar-item">
                                    <a href="{{ route('admin.faqs.create') }}" class="sidebar-link {{ Route::is('admin.faqs.create') ? 'active' : null }}">
                                        <i class="mdi mdi-plus-circle"></i>
