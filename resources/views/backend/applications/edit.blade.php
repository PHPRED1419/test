...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.applications.update', $application->applications_id) }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                @method('put')
                <div class="form-body">
                    <div class="card-body">
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel"
                                        ...
                                        @include('backend.applications.partials.general', ['application' => $application])
                                    </div>
                                    ...
                                    <div class="tab-pane fade" id="v-pills-social" role="tabpanel"
                                        ...
                                        ['application' => $application, 'medias' => $medias]
                                        )
                                    </div>
                                </div>
