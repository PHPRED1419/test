...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('admin.products.update', $product->products_id) }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                @method('put')
                <div class="form-body">
                    <div class="card-body">
                            ...
                            <div class="col-md-12 mt-4">
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-general" role="tabpanel"
                                        ...
                                        @include('backend.products.partials.general', ['product' => $product])
                                    </div>
                                    <?php
                                    /*<div class="tab-pane fade" id="v-pills-contact" role="tabpanel"
                                        aria-labelledby="v-pills-contact-tab">
                                        @include('backend.products.partials.entities', 
                                        ['product' => $product, 'brands' => $brands, 'models' => $models,'sizes' => $sizes,'colors' => $colors]
                                        )
                                    </div>
                                    */
                                    ?>
