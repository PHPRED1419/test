<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="contact_no">Whatsapp</label>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="address">Whatsapp Text</label>
            <textarea class="form-control" rows="2" id="whatsapp_text" name="whatsapp_text" placeholder="Site whatsapp text">{{ $settings->contact->whatsapp_text }}</textarea>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="address">Google Map Code</label>
            <textarea class="form-control" rows="2" id="google_map" name="google_map" placeholder="Site google map">{{ $settings->contact->google_map }}</textarea>
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
