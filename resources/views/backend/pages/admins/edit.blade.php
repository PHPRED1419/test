                ...
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-3"> <?php /*required=""  */ ?>
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" id="password" name="password"
                                        ...
                                        autocomplete="off" /> {{-- data-parsley-equalto="#password_confirmation"  --}}
                                </div>
                            </div>
                            {{--<div class="col-md-6">
                                <div class="form-group">
                    ...
                    */
                    ?>
                    <div class="form-actions" style="margin-top: 23px;margin-left: 10px;">
                        <div class="card-body">
