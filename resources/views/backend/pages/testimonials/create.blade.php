...
@section('admin-content')
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                @csrf
                <div class="form-body">
                    <div class="card-body">
                        <div class="row ">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label" for="title">Comment <span class="required">*</span></label>
                                     <textarea style="height:100px;" class="form-control" id="description" name="description"  placeholder="Enter Comment" required=""/>{{ old('description') }}</textarea>
                                </div>
