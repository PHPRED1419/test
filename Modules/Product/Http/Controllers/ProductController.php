...
class ProductController extends Controller
{
   ...
   // dd($category);
		if(isset($category->id))
		{
        	...
        	return view('product::index', compact('products','categories','categoryId'));
		}
		else
		{
...
{  
    $productName = $request->input('mysearchString', '');
    $query = Product::query();
    ...
    if(!empty($products)) {
        foreach ($products as $val) {
            ...
            $output .= '<li onClick="fill(\''.$product_title.'\');">'.$product_title.'</li>';
        }
    }
