...
namespace Modules\Acategory\Entities;
...
{
    return $this->hasMany(Acategory::class, 'parent_category_id');
}
// Define the relationship for subcategories
public function subcategories()
{
    return $this->hasMany(Acategory::class, 'parent_category_id')->where('status', 1);
}

// Optional: Define inverse relationship
public function parent()
{
    return $this->belongsTo(Acategory::class, 'parent_category_id');
}
