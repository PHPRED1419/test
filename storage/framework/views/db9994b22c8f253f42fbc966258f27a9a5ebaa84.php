        ...
        <div class="tab-content" id="pills-tabContent">
                    ...
                    <li>
                        <div class="message-center chat-scroll">
                            <a href="javascript:void(0)" class="message-item" id='chat_user_1' data-user-id='1'>
                                <span class="user-img">
                                    <img src="<?php echo e(asset('public/assets/backend/images/user.jpg')); ?>" alt="user" class="rounded-circle">
            ...
            <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user" src="<?php echo e(asset('public/assets/backend/images/user.jpg')); ?>"> </div>
                        <div class="sl-right">
...
</aside><?php /**PATH E:\wamp64\www\Laravel-HRhelpboard\resources\views/backend/layouts/partials/theme-options.blade.php ENDPATH**/ ?>