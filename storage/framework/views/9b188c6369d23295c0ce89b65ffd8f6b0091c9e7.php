...
<?php $__env->startSection('admin-content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="create-page">
            <form action="<?php echo e(route('admin.categories.update', $category->id)); ?>" method="POST" enctype="multipart/form-data" data-parsley-validate data-parsley-focus="first">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="<?php echo e($category->name); ?>" placeholder="Enter Category Name" required=""/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="slug">Short URL <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="slug" name="slug" value="<?php echo e($category->slug); ?>" placeholder="Enter short url (Keep blank to auto generate)" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="priority" name="priority" value="<?php echo e($category->priority); ?>" placeholder="Enter Display Order (Lower=Higher); eg-1 or 1.1" min="0"/>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group has-success">
                                    ...
                                    <select class="form-control custom-select" id="status" name="status" required>
                                        <option value="1" <?php echo e($category->status === 1 ? 'selected' : null); ?>>Active</option>
                                        <option value="0" <?php echo e($category->status === 0 ? 'selected' : null); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            */
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" data-height="100" data-allowed-file-extensions="png jpg jpeg webp" id="category_image" name="category_image" data-default-file="<?php echo e($category->category_image != null ? asset('assets/images/categories/'.$category->category_image) : null); ?>" />
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="editor" name="description" class="form-control"><?php echo $category->description; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="meta_description">Category Meta Description <span class="optional">(optional)</span></label>
                                    <textarea type="text" class="form-control" id="meta_description" name="meta_description" placeholder="Meta description for SEO"><?php echo $category->meta_description; ?></textarea>
                                </div>
                                <?php
                                /*
                                <div class="row">
                            ...
                            <div class="form-actions">
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo e(route('admin.categories.index')); ?>" class="btn btn-dark">Cancel</a>
                                </div>
                            </div>
...
<script>
    ClassicEditor
        .create(document.querySelector('#editor'), {
            ...
            ckfinder: {
                uploadUrl: '<?php echo e(route("admin.ckeditor.upload")); ?>'
            },
            mediaEmbed: {
                previewsInData: true
            },
...
<?php echo $__env->make('backend.categories.partials.scripts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp64\www\Laravel-HRhelpboard\resources\views/backend/categories/edit.blade.php ENDPATH**/ ?>